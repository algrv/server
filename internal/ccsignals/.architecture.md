...
| Strudel validator      | `algojams_adapter.go` | ContentValidator for strudels (ownership checks) |
...
├── algojams_adapter.go   # ContentValidator for Algojams strudels
...
```go
import "codeberg.org/algojams/server/internal/ccsignals"
